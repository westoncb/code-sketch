const codeSketchFormat = `
  ...
  `;
const sketchProcessingPreamble = (sketch, contextItems = [{ id: "-1", content: 'no additional context' }]) => {
...
export const genCodePrompt = (sketch, contextItems) => {
...
export const genReviewPrompt = (sketch, contextItems) => {
    return `${sketchProcessingPreamble(sketch, contextItems)}
...
export const getRefineSketchPrompt = (reconstructedSketch) => {
