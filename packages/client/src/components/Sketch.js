...
function Sketch() {
    ...
    return (_jsxs("div", { style: styles.container, children: [_jsx("div", { ref: editor, style: styles.editor }), _jsxs("div", { style: styles.buttonPanel, children: [_jsx(Button, { style: { marginRight: "8px", flexGrow: 1 }, onClick: generateReview, children: "Review Sketch" }), _jsx(Button, { style: { flexGrow: 1 }, onClick: generateCode, children: "Generate Code" })] }), _jsx(ContextBar, {})] }));
}
