...
function Code() {
    ...
    return (_jsxs("div", { style: styles.container, children: [_jsx("div", { ref: editor, style: styles.editor }), comments && _jsx("div", { style: styles.model, children: llmConfig.model + ":" }), comments && _jsx("div", { style: styles.comments, children: comments })] }));
}
