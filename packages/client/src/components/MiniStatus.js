...
const MiniStatus = ({ config }) => {
    ...
    return (_jsx("div", { style: styles.overlay, children: _jsxs("div", { style: styles.popup, children: [showSpinner && (_jsx("canvas", { ref: canvasRef, width: 160, height: 144, style: styles.canvas })), message && (_jsx("div", { style: styles.message, children: message })), onConfirm && (_jsx(Button, { onClick: confirmAndClose, style: styles.button, children: "Okay" }))] }) }));
};
